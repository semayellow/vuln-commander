...
class Config:
    CONNECTOR_ID: str = os.environ.get('CONNECTOR_GSS_UUID')
    CONNECTOR_PASSWORD: str = os.environ.get('CONNECTOR_GSS_PASSWORD')
    ...
    SCANER_PATH: str = 'gss/scanner/noseyparker'
    CONNECTOR_TYPE: str = 'gss'
