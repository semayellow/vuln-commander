...
class Config:
    CONNECTOR_ID: str = os.environ.get('CONNECTOR_SCA_VULN_UUID')
    CONNECTOR_PASSWORD: str = os.environ.get('CONNECTOR_SCA_VULN_PASSWORD')
    ...
    SCANER_PATH: str = 'sca-vuln/scanner/trivy'
