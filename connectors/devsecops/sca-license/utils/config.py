...
class Config:
    CONNECTOR_ID: str = os.environ.get('CONNECTOR_SCA_LICENSE_UUID')
    CONNECTOR_PASSWORD: str = os.environ.get('CONNECTOR_SCA_LICENSE_PASSWORD')
    ...
    SCANER_PATH: str = 'sca/scanner/trivy'
    CONNECTOR_TYPE = ConnectorType.sca_license
